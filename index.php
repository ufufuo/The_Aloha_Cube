<?php
	...
	# Include PHP Functions (dock build function)
...
<head>
	...
	<?php print twitterDock('twitterbar', simplexml_load_file('cfg/twitter.xml')); /*** Build JS Function For Dock ***/ ?>
	
	<!-- Demo: Stylesheet -->
	<link rel="stylesheet" type="text/css" href="css/cube.css" />
	
	<!-- Aloha Media Plugin CSS -->
	<?php print cssMediaRepository(); /* not yet done (daniel) */ ?>
